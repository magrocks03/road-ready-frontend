...
import heroBackground from '../../assets/images/hero-background.jpg'; // <-- Import your hero background image
            ...
            <div className="bg-card/20 backdrop-blur-lg p-6 rounded-lg shadow-2xl border border-white/20 md:flex md:items-center md:gap-4 space-y-4 md:space-y-0">
              ...
              <div className="flex-1">
                ...
                <div className="relative">
                  ...
                  <select id="location" className="w-full pl-10 pr-4 py-2 bg-background border border-border text-text-primary rounded-md shadow-sm focus:ring-primary focus:border-primary">
                    <option>Select a location</option>
                    <option>Chennai Airport (MAA)</option>
                    <option>Bangalore Downtown</option>
              ...
              {/* Search Button */}
              <button className="w-full md:w-auto mt-4 md:mt-0 self-end px-6 py-2 h-[42px] font-medium text-white bg-primary rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary transition duration-300 ease-in-out hover:-translate-y-1 hover:scale-110 hover:bg-primary-hover">
                Search
              </button>
            </div>
          </div>
