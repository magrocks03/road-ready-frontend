...
import { getAllIssuesForOperatorApiCall } from '../../../services/OperationsService';
import ManageIssueModal from '../../Admin/IssueManagement/ManageIssueModal'; // Reusing the modal
import { format } from 'date-fns';

const AllIssuesPageAgent = () => {
  ...
  const { data: response, isLoading, error } = useFetch(
    () => getAllIssuesForOperatorApiCall(page),
    [page, refetchIndex]
  );
...
export default AllIssuesPageAgent;